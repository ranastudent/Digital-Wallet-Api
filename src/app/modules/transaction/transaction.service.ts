...
export const TransactionService = {
  ...
  // Get all cash-in transactions done by the agent
  cashInSummaryByAgent: async (agentId: string) => {
  ...
  // Get all cash-out transactions done by the agent
  cashOutSummaryByAgent: async (agentId: string) => {
    const transactions = await Transaction.find({
      agent: agentId,
      type: "cash-out",
    })
